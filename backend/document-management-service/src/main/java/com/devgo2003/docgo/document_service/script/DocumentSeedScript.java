...
public class DocumentSeedScript implements CommandLineRunner {
    ...
    private List<Contract> createSampleDocuments() {
        return Arrays.asList(
            ...
            createContract(
                ...
                ContractCategory.COMMERCIAL_SERVICES_CONSULTING,
                "Máy tính văn phòng",
                "2024-01-15",
                "2024-12-31",
                "50000000",
            ...
            createContract(
                ...
                ContractCategory.COMMERCIAL_PROCUREMENT_EQUIPMENT,
                "Thuê văn phòng",
                "2024-03-01",
                "2025-02-28",
                "300000000",
            ...
            createContract(
                ...
                ContractCategory.COMMERCIAL_PROCUREMENT_PURCHASE,
                "Thiết bị văn phòng",
                "2024-04-01",
                "2024-06-30",
                "25000000",
            ...
            createContract(
                ...
                ContractCategory.LEGAL_COMPLIANCE_GDPR,
                "Tư vấn pháp lý",
                "2024-05-01",
                "2024-12-31",
                "80000000",
            ...
            createContract(
                ...
                ContractType.INSURANCE_AGREEMENT,
                ContractCategory.LEGAL_COMPLIANCE_ISO27001,
                "Bảo hiểm tài sản",
                "2023-01-01",
                "2023-12-31",
                "15000000",
            ...
            createContract(
                ...
                ContractCategory.HR_EMPLOYMENT_CONTRACT,
                "Lao động",
                "2024-06-01",
                "2025-05-31",
                "180000000",
            ...
            createContract(
                ...
                ContractStatus.PENDING_REVIEW,
                ContractType.MARKETING_AGREEMENT,
                ContractCategory.COMMERCIAL_MARKETING_ADVERTISING,
                "Marketing digital",
                "2024-07-01",
                "2024-12-31",
                "60000000",
    ...
    private Contract createContract(
        ...
        contract.setProcessingStatus(Contract.ProcessingStatus.PENDING_REVIEW);
