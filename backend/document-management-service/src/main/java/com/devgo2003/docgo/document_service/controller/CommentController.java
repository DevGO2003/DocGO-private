...
@RestController
@RequestMapping("/api/v1/document-management-service/v1/comments")
@Tag(name = "💬 APIs Quản lý Bình luận", description = "Các API để quản lý bình luận và cộng tác trong hệ thống DocGO")
