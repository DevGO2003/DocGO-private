...
class EnhancedServiceManager {
  ...
  private setupLoadBalancer(): void {
    ...
    loadBalancer.addService('document-management', [
      {
        id: 'doc-mgmt-1',
        url: process.env.FILE_MANAGEMENT_SERVICE_URL || 'http://repository-management-service:8002',
        weight: 1
      }
    ]);
  ...
  private setupServices(): void {
    ...
    this.addService('document-management', {
      ...
      url: selectUrl(process.env.FILE_MANAGEMENT_SERVICE_URL, 'http://repository-management-service:8002', 'http://localhost:8002'),
