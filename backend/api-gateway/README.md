...
- `repository-management-service` → 8002 → 8000  
...
FILE_MANAGEMENT_SERVICE_URL=http://repository-management-service:8000
...
```
GET    /api/v1/repository-management-service/documents
POST   /api/v1/repository-management-service/documents
GET    /api/v1/repository-management-service/documents/{id}
PUT    /api/v1/repository-management-service/documents/{id}
DELETE /api/v1/repository-management-service/documents/{id}
```
