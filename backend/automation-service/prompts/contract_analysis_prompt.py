  ...
  "clauses": {{  // object - các điều khoản
    ...
    "unfavorable": [  // array of objects - điều khoản bất lợi (hạn chế, nghĩa vụ nặng, rủi ro)
      {{
        ...
        "affectedParties": [  // array of strings - danh sách ID các bên bị ảnh hưởng, vd: ["party-001", "party-002"]
          null  // string - ID bên bị ảnh hưởng
        ],
        "pageNumber": null
      }}
    ],
...
1. ⚠️ BƯỚC ĐẦU TIÊN - ĐẾM ĐIỀU KHOẢN:
   - QUÉT TOÀN BỘ hợp đồng từ đầu đến cuối
   - LIỆT KÊ TẤT CẢ các điều khoản: Điều 1, Điều 2, Điều 3, ..., Điều N
   - ĐẾM tổng số điều khoản (VD: "Tìm thấy 9 điều khoản")
   - KHÔNG được bỏ sót bất kỳ điều khoản nào, kể cả những điều khoản nhỏ hoặc ở cuối tài liệu
2. Với mỗi điều khoản tìm thấy:
...
3. KIỂM TRA CUỐI CÙNG:
   - Số lượng items trong "clauses.all" PHẢI BẰNG tổng số điều khoản đã đếm
   - Mỗi điều khoản trong "clauses.all" PHẢI có "content" (trích dẫn chính xác)
