...
class Logger:
    """Centralized logger for Document Management Service"""
    ...
    def _setup_logger(self):
        ...
        self._logger = logging.getLogger('repository-management-service')
        ...
        file_handler = logging.FileHandler(log_dir / "repository-management-service.log")
    ...
    def log_file_operation(self, operation: str, file_path: str, file_size: int, request_id: str, correlation_id: str, **kwargs):
        """Log file operation"""
        self.info(
            f"File {operation}: {file_path} ({file_size} bytes)",
            request_id=request_id,
            correlation_id=correlation_id,
            extra_fields={
...
def log_file_operation(operation: str, file_path: str, file_size: int, request_id: str, correlation_id: str, **kwargs):
    """Log file operation"""
    logger.log_file_operation(operation, file_path, file_size, request_id, correlation_id, **kwargs)
