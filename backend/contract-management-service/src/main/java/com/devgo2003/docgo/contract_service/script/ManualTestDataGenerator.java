...
public class ManualTestDataGenerator {
    ...
    private List<Contract> createTestContracts() {
        ...
        contract1.setContractType(ContractType.SERVICE_AGREEMENT);
        ...
        contract2.setStatus(ContractStatus.PENDING_REVIEW);
        ...
        contract2.setContractType(ContractType.LEASE_AGREEMENT);
        ...
        contract2.setProcessingStatus(Contract.ProcessingStatus.PENDING_REVIEW);
        ...
        contract2.setComplianceStatus("PENDING_REVIEW_REVIEW");
        ...
        contract3.setStatus(ContractStatus.DRAFT);
        ...
        contract3.setContractType(ContractType.SUPPLY_AGREEMENT);
        ...
        contract3.setProcessingStatus(Contract.ProcessingStatus.PENDING_REVIEW);
        ...
        contract3.setTags(Arrays.asList("Construction", "Materials", "Supply Chain"));
        ...
        contract4.setContractType(ContractType.SERVICE_AGREEMENT);
        ...
        contract4.setTags(Arrays.asList("Logistics", "Transportation", "Delivery"));
        ...
        contract5.setStatus(ContractStatus.PENDING_REVIEW);
        ...
        contract5.setContractType(ContractType.INSURANCE_AGREEMENT);
        ...
        contract5.setProcessingStatus(Contract.ProcessingStatus.PENDING_REVIEW);
        ...
        contract5.setComplianceStatus("PENDING_REVIEW_REVIEW");
        contract5.setLegalReviewRequired(true);
        contract5.setTags(Arrays.asList("Insurance", "Life Insurance", "Employee Benefits"));
