#!/usr/bin/env python3
"""
Script to fix remaining gradient violations - final pass.
...
# Comprehensive gradient mappings
GRADIENT_MAP = {
    # Blue gradients
    ...
    'from-blue-100 to-blue-200': 'backgroundImage: \'linear-gradient(to bottom right, #dbeafe, #bfdbfe)\'',
    ...
    'from-green-50 to-white': 'backgroundImage: \'linear-gradient(to bottom right, #f0fdf4, #ffffff)\'',
    
    # Red gradients
    'from-red-50 to-red-100': 'backgroundImage: \'linear-gradient(to bottom right, #fef2f2, #fee2e2)\'',
    'from-red-50 to-white': 'backgroundImage: \'linear-gradient(to bottom right, #fef2f2, #ffffff)\'',
    ...
    'from-gray-50 to-gray-100': 'backgroundImage: \'linear-gradient(to bottom right, #f9fafb, #f3f4f6)\'',
}

def fix_gradients_final(file_path: str) -> int:
...
def main():
    ...
    for tsx_file in tsx_files:
        fixed = fix_gradients_final(str(tsx_file))
        total_fixed += fixed
