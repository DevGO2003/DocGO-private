# GitHub Get Pull Request Reviews Command

## Mục đích
Lấy danh sách reviews của pull request.

## Cách sử dụng
```bash
/github-get-pr-reviews <owner> <repo> <pull_number>
```

## Tham số
- `<owner>`: Repository owner (username hoặc organization) (bắt buộc)
- `<repo>`: Repository name (bắt buộc)
- `<pull_number>`: Số pull request cần lấy reviews (bắt buộc)
...
- Gọi `mcp_Github_get_pull_request_reviews` với parameters
...
- Gợi ý sử dụng reviews

## Kết quả mong đợi
- 📊 **Danh sách reviews** của PR
...
## Ví dụ sử dụng
```
/github-get-pr-reviews devgo2003 docgo-private 123
/github-get-pr-reviews devgo2003 docgo-private 456
/github-get-pr-reviews devgo2003 docgo-private 789
```
