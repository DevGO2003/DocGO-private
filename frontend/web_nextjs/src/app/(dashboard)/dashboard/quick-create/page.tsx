...
export default function QuickCreatePage() {
  ...
  const handleCreateContract = async () => {
    ...
    try {
      ...
      const mappedContractType = result.contractType 
        ? mapContractTypeToEnum(result.contractType)
        : 'EMPLOYMENT_CONTRACT'
      ...
      <div className="space-y-8 max-w-6xl mx-auto px-2 sm:px-4">
        ...
        <div className="relative overflow-hidden rounded-2xl border bg-white shadow-sm ring-1 ring-gray-100">
          ...
          <div className="relative px-6 py-6">
            ...
            <p className="mt-1 text-gray-600">Sử dụng OCR để trích xuất thông tin từ file tài liệu.</p>
          </div>
