...
import { RepositoryTabs } from '@features/repository/views/components/RepositoryTabs';
import { RepositoryGrid } from '@features/repository/views/components/RepositoryGrid';
import { CreateRepositoryModal } from '@features/repository/views/components/CreateRepositoryModal';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto">
        ...
        <HeaderPanel
          ...
          description="Manage your document repositories and files"
          actions={
            <Button
              variant="outline"
