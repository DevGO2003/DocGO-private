...
export default function SystemInfoPanel() {
  return (
    <div className="rounded-2xl border" style={ borderColor: '#e5e7eb' } style={ backgroundColor: '#ffffff', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)' }>
      ...
      <div className="p-4 space-y-3">
        ...
        {/* Tip */}
        <div className="border rounded-lg p-3 flex items-start space-x-3" style={ borderColor: '#bfdbfe' } style={ backgroundColor: '#eff6ff' }>
          <div className="h-8 rounded-full flex items-center justify-center flex-shrink-0" style={ backgroundColor: '#3b82f6' }>
            <svg style={ color: '#ffffff' } fill="none" stroke="currentColor" viewBox="0 0 24 24">
