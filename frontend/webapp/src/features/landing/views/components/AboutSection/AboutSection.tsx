  ...
  return (
    <section id="about" className="py-16 bg-white/80">
      <div className="max-w-7xl mx-auto px-6">
        <CommonText as="h2" className="text-2xl md:text-3xl font-semibold text-gray-900">Giới thiệu</CommonText>
        <CommonText as="p" className="mt-4 text-gray-600 max-w-3xl">
