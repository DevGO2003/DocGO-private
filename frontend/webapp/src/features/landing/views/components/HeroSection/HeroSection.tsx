  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        ...
        {/* Title */}
        <div ref={titleRef}>
          <CommonText as="h1" className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
        ...
        {/* Description */}
        <div ref={descRef}>
          <CommonText as="p" className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
        ...
        <div ref={statsRef} className="mt-16 grid grid-cols-3 gap-8 max-w-3xl mx-auto">
          <div>
            ...
            <CommonText as="p" className="text-gray-600 mt-1">
