...
export const OrganizationDetail = () => {
  ...
  if (orgLoading) {
    return <LoadingSpinner text="Loading organization..." fullScreen />;
  }
            ...
            <Card animated>
              ...
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">No repositories in this organization yet</p>
                </div>
              </CardContent>
            </Card>
          )}
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div>
                          <p className="font-medium text-gray-900">Public Organization</p>
                      ...
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div>
                          <p className="font-medium text-gray-900">Allow Invitations</p>
                          <p className="text-sm text-gray-600">
                  ...
                  <div className="pt-6 border-t border-gray-200">
                    ...
                    <div className="p-4 border-2 border-red-200 bg-red-50 rounded-lg">
                      ...
                      <p className="text-sm text-red-700 mb-4">
                        Once deleted, this organization cannot be recovered
                      </p>
                      <Button variant="outline" className="text-red-600 hover:text-red-700" animated>
                        Delete Organization
                      </Button>
                    </div>
                  </div>
