...
export default function DocumentDetailPage() {
  const params = useParams() as { fileId?: string; repositoryId?: string }
  ...
  useEffect(() => {
    console.log('Detail page loaded for fileId:', params.fileId, 'repositoryId:', params.repositoryId)
    ...
    const fetchDetail = async () => {
      ...
      try {
        ...
        const currentFileId = params.fileId || params.repositoryId as string
    ...
    fetchDetail()
  }, [params.fileId, params.repositoryId, router])
      ...
      <div className="space-y-6">
        <HeaderPanel
          ...
          breadcrumbs={[
            ...
            { label: 'Danh sách', href: `/repositories/${params.repositoryId}/files` },
