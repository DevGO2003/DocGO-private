    ...
    <div className="bg-white/80 backdrop-blur rounded-lg p-[0px] shadow-sm w-full">
      ...
      <div className="flex items-center gap-[10px] w-full">
        ...
        <select
            ...
            className="h-10 px-2 pr-6 min-w-[120px] rounded-lg border border-indigo-300 text-sm text-indigo-700 bg-white hover:bg-indigo-50 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
          >
            <option value="asc">Tăng dần</option>
            <option value="desc">Giảm dần</option>
          </select>
          <button onClick={props.onRefresh} className="inline-flex items-center gap-1 px-3 h-10 rounded-lg border border-indigo-300 text-sm text-indigo-700 hover:bg-indigo-50"><ArrowPathIcon className="w-4 h-4"/>Làm mới</button>
        </div>
      </div>

      {/* Row 2: Advanced toggle + triggers + Reset + View toggle */}
      <div className="flex items-center gap-[10px] w-full mt-[10px]">
